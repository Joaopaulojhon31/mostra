  ...
  <br><br><br>
	...
	<div id="gallery" style="display:none;">
		...
		<img alt="Enfermagem"
			 ...
			 data-description="Enfermagem">
		<img alt="Enfermagem"
			 src="componentes/imagens/Enfermagem/01.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Enfermagem/01.jpg"
			 data-description="Enfermagem">
		<img alt="Enfermagem"
			 src="componentes/imagens/Enfermagem/02.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Enfermagem/02.jpg"
			 data-description="Enfermagem">
		<img alt="Enfermagem"
			 src="componentes/imagens/Enfermagem/03.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Enfermagem/03.jpg"
			 data-description="Enfermagem">
