 ...
 <!-- menu -->
  ...
  <br><br><br>
	...
	<div id="gallery" style="display:none;">
		...
		<img alt="Meio Ambiente"
			 src="componentes/imagens/MeioAmbiente/big-ma1.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/MeioAmbiente/big-ma1.jpg"
			 data-description="Meio Ambiente">
		<img alt="Meio Ambiente"
			 src="componentes/imagens/MeioAmbiente/01.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/MeioAmbiente/01.jpg"
			 data-description="Meio Ambiente">
		<img alt="Meio Ambiente"
			 src="componentes/imagens/MeioAmbiente/capa.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/MeioAmbiente/capa.jpg"
			 data-description="Meio Ambiente">
