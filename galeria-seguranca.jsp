...
<jsp:include page="menu.jsp"/>
  ...
  <br><br><br>
	...
	<div id="gallery" style="display:none;">
		...
		<img alt="Segurança do Trabalho"
			 src="componentes/imagens/Seguranca/big-seg1.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Seguranca/big-seg1.jpg"
			 data-description="Segurança do Trabalho">
		<img alt="Segurança do Trabalho"
			 src="componentes/imagens/Seguranca/01.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Seguranca/01.jpg"
			 data-description="Segurança do Trabalho">
		<img alt="Segurança do Trabalho"
			 src="componentes/imagens/Seguranca/02.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Seguranca/02.jpg"
			 data-description="Segurança do Trabalho">
		<img alt="Segurança do Trabalho"
			 src="componentes/imagens/Seguranca/03.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Seguranca/03.jpg"
			 data-description="Segurança do Trabalho">
		<img alt="Segurança do Trabalho"
			 src="componentes/imagens/Seguranca/04.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Seguranca/04.jpg"
			 data-description="Segurança do Trabalho">
		<img alt="Segurança do Trabalho"
			 src="componentes/imagens/Seguranca/05.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Seguranca/05.jpg"
			 data-description="Segurança do Trabalho">
