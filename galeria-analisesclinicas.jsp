...
<!-- menu -->
  ...
  <br><br><br>
	...
	<div id="gallery" style="display:none;">
		...
		<img alt="Análises Clínicas"
			 src="componentes/imagens/Enfermagem/big-en1.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Enfermagem/big-en1.jpg"
			 data-description="Análises Clínicas"/>
		<img alt="Análises Clínicas"
			 src="componentes/imagens/Analises/01.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Analises/01.jpg"
			 data-description="Análises Clínicas"/>
		<img alt="Análises Clínicas"
			 src="componentes/imagens/Analises/02.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Analises/02.jpg"
			 data-description="Análises Clínicas"/>
		<img alt="Análises Clínicas"
			 src="componentes/imagens/Analises/03.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Analises/03.jpg"
			 data-description="Análises Clínicas"/>
		<img alt="Análises Clínicas"
			 src="componentes/imagens/Analises/04.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Analises/04.jpg"
			 data-description="Análises Clínicas"></img>
		<img alt="Análises Clínicas"
			 src="componentes/imagens/Analises/05.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Analises/05.jpg"
			 data-description="Análises Clínicas"></img>
		<img alt="Análises Clínicas"
			 src="componentes/imagens/Analises/06.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Analises/06.jpg"
			 data-description="Análises Clínicas"></img>
		<img alt="Análises Clínicas"
			 src="componentes/imagens/Analises/07.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Analises/07.jpg"
			 data-description="Análises Clínicas"></img>
		<img alt="Análises Clínicas"
			 src="componentes/imagens/Analises/08.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Analises/08.jpg"
			 data-description="Análises Clínicas"></img>
		<img alt="Análises Clínicas"
			 src="componentes/imagens/Analises/09.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Analises/09.jpg"
			 data-description="Análises Clínicas"></img>
		<img alt="Análises Clínicas"
			 src="componentes/imagens/Analises/10.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Analises/10.jpg"
			 data-description="Análises Clínicas">
		<img alt="Análises Clínicas"
			 src="componentes/imagens/Analises/11.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Analises/11.jpg"
			 data-description="Análises Clínicas"></img>;
		<img alt="Análises Clínicas"
			 src="componentes/imagens/Analises/12.jpg" height="11%" width="11%"
			 data-image="imagens/Analises/12.jpg"
			 data-description="Análises Clínicas"></img>
		<img alt="Análises Clínicas"
			 src="componentes/imagens/Analises/14.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Analises/14.jpg"
			 data-description="Análises Clínicas"></img>
		<img alt="Análises Clínicas"
			 src="componentes/imagens/Analises/15.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Analises/15.jpg"
			 data-description="Análises Clínicas"></img>
		<img alt="Análises Clínicas"
			 src="componentes/imagens/Analises/capa.jpg" height="11%" width="11%"
			 data-image="componentes/imagens/Analises/capa.jpg"
			 data-description="Análises Clínicas"></img>
